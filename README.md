...
Conversa is an iOS application that helps deaf and hard-of-hearing travelers communicate confidently while traveling. The app combines AI assistance, translation, speech-to-text, and text-to-speech into a single experience designed for real-world travel situations.
...
The app supports four primary contexts:

* **Transport** for airports, flights, taxis, buses, and trains.
* **Hotel** for check-in, room requests, facilities, and accommodations.
* **Store** for shopping, pharmacies, groceries, and product inquiries.
* **Quick Chat** for everyday communication, asking strangers for help, directions, or emergency situations.
...
The application is built with SwiftUI for iOS and uses AI services for conversational assistance, speech recognition, translation, and text-to-speech capabilities.
...
Conversa aims to remove communication barriers and make travel more accessible for deaf and hard-of-hearing individuals. By combining AI, accessibility, and travel assistance, Conversa helps users navigate unfamiliar environments with greater independence and confidence.
